...
namespace LitePlacer
{
    ...
    public class MySettings : IMySettings
    {
        ...
        public double Calibration_Common_X  { get; set; } = 1.0;
        public double Calibration_Common_Y  { get; set; } = 1.0;
        public double Calibration_A_Marker_X  { get; set; } = 0.0;
        public double Calibration_A_Marker_Y  { get; set; } = 0.0;
        public double Calibration_B_Marker_X  { get; set; } = 0.0;
        public double Calibration_B_Marker_Y  { get; set; } = 0.0;
        public double Calibration_C_Marker_X  { get; set; } = 0.0;
        public double Calibration_C_Marker_Y  { get; set; } = 0.0;
        public double Calibration_D_Marker_X  { get; set; } = 0.0;
        public double Calibration_D_Marker_Y  { get; set; } = 0.0;
        public double Calibration_E_Marker_X  { get; set; } = 0.0;
        public double Calibration_E_Marker_Y  { get; set; } = 0.0;
        public double Calibration_X_Quanta_Step_Size  { get; set; } = 20.0;
        public double Calibration_Y_Quanta_Step_Size  { get; set; } = 20.0;
    }
    ...
    public class AppSettings
    {
        ...
        public bool Save(IMySettings pSettings, string FileName)
        {
            try
            {
        ...
        public IMySettings Load(string FileName)
        {
            try
            {
